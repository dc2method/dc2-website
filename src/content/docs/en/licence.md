...
- **Attribution** : You must credit **Eric Gauthier** as the original author, provide a link to the license, and indicate if changes were made. You must do so in a reasonable manner, but not in any way that suggests the author endorses you or your use.
...
To read the complete legal text of the CC BY-SA 4.0 license:
[https://creativecommons.org/licenses/by-sa/4.0/](https://creativecommons.org/licenses/by-sa/4.0/)

## Website Source Code

The source code of this website (Astro structure, React components, CSS) is also available under the CC BY-SA 4.0 license. You can consult, reuse, and adapt it under the same conditions.
