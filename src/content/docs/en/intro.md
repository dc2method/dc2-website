...
→ [**Explore the Theoretical Foundations**](/en/fondements-theoriques) to understand why DC² works
...
→ [**Read the Architectural Foundations**](/en/fondements-theoriques#ia-comme-composant) to understand the underlying pattern
...
→ [**Explore the Theoretical Foundations**](/en/fondements-theoriques)
